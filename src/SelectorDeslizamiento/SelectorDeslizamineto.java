...
* @author
*/
public class SelectorDeslizamineto extends AnchorPane {
    @FXML
    ...
    public SelectorDeslizamineto() {
       FXMLLoader fxmlLoader = new FXMLLoader(
       getClass().getResource("SelectorDeslizamineto.fxml"));
 ...
 private ObjectProperty<EventHandler<ActionEvent>> onAction = new ObjectPropertyBase<EventHandler<ActionEvent>>() {
        ...
        public Object getBean() {
            return SelectorDeslizamineto.this;
        }
        @Override
